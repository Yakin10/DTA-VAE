...
class CNN(nn.Module):
    def __init__(self, num_filters, k_size):
        ...
        self.conv2 = nn.Sequential(
            nn.Dropout(0.2),
            nn.Conv1d(num_filters, num_filters * 2, k_size, 1, k_size//2),
            
        )
        self.conv3 = nn.Sequential(
            nn.Dropout(0.2),
            nn.Conv1d(num_filters * 2, num_filters * 3, k_size, 1, k_size//2),
...
class net(nn.Module):
    def __init__(self, FLAGS, NUM_FILTERS, FILTER_LENGTH1, FILTER_LENGTH2):
        ...
        self.cnn2 = CNN1(NUM_FILTERS, FILTER_LENGTH2)
