...
CHARSELFSET = {".": 0, "[#Branch1]": 1, "[#Branch2]": 2, "[#C]": 3, "[#N]": 4, "[/-Ring1]": 5, "[/C]": 6, "[/N]": 7, "[/S]": 8, "[2H]": 9, "[=Branch1]": 10, 
               ...
               "[I-1]": 31, "[I]": 32, "[N+1]": 33, "[N]": 34, "[O-1]": 35, "[OH0]": 36, "[O]": 37, "[P]": 38, "[Ring1]": 39, "[Ring2]": 40, 
               "[S@@]": 41, "[S@]": 42, "[S]": 43, "[\\-Ring1]": 44, "[\\C]": 45, "[\\N]": 46, "[nop]": 47}
...
def selfies_to_label(selfie, largest_drug_len, CHARSELFSET):
    ...
    selfies_split = sf.split_selfies(selfie)
    for i, c in enumerate(selfies_split):
        x[i] = int(CHARSELFSET[c])
    return x
def multiple_selfies_to_label(selfie_list, largest_drug_len, CHARSELFSET):
    label_list = []
